...
<el-container style="height: 100vh">
  <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
    <el-menu router  unique-opened default-active="$route.path" >
      <!-- //添加router后点击会跳转到index指定的路 :default-openeds="['3']" :default-openeds默认展开的  unique-opened每次只展开一个   -->
      <el-submenu index="1">
        <template slot="title"><i class="el-icon-message"></i>内容管理</template>
        <el-menu-item-group>
          <template slot="title">物品</template>
          <el-menu-item index="/goods/create">新建物品</el-menu-item>
          <el-menu-item index="/goods/list">物品管理</el-menu-item>
        </el-menu-item-group>
        <el-menu-item-group>
  ...
  <el-container>
    ...
    <el-main>
      <router-view :key="$route.path">
        <!-- :key已路由区分界面解决编辑页面跳转到新建页面后数据仍保留的bug -->
      </router-view>
